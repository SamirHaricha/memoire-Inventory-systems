    ...
    <div class="item">
      <ul class="nostyle zero">
       ...
       <a href="addnew.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Add New Item</li></a>
        <a href="reports.php"><li><i class="fa fa-circle-o fa-fw"></i> Sold Report</li></a>
      </ul><
    </div>
  </div>
...
if ($con->query("insert into inventeries (catId,supplier,name,unit,price,company) values ('$_POST[catId]','$_POST[supplier]','$_POST[name]','$_POST[unit]','$_POST[price]','$_POST[company]')")) {
  $notice ="<div class='alert alert-success'>Successfully Saved</div>";
}
else{
